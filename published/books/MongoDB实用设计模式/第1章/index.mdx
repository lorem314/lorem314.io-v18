...
<Figure id="1-1" src="/books/MongoDB实用设计模式/第1章/图片1-1硬盘查找VS连续访问.png" title="硬盘查找VS连续访问" />
...
<aside>
🐾 有趣的是，许多关系数据库系统放宽了事务之间完全隔离的要求，引入了各种隔离级别。 因此，如果您可以将更新结构化为仅单文档更新，则可以获得序列化（最保守）隔离级别的效果，而不会影响关系数据库系统中的任何性能。
</aside>
